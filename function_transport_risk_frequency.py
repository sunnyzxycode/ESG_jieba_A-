# transport risk solution

import jieba
from collections import Counter

def transport_risk_solution_frequency(file_path):

    # 加载自定义词库
    custom_dict_path = r"C:\Users\zxy\OneDrive\桌面\ESG_20241021\转型风险v1.0.txt"
...
if __name__ == "__main__":
    ...
    transport_risk_solution_frequency(owner_path)