...
def low_risk_solution_frequency(file_path):

    # 加载自定义词库
    custom_dict_path = r"C:\Users\zxy\OneDrive\桌面\ESG_20241021\三分类_慢性风险（物理风险）.txt"
...
if __name__ == "__main__":
    ...
    low_risk_solution_frequency(owner_path)